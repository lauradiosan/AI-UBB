...
Rezolvati cerinta de mai sus folosind un clasificator bazat pe retele neuronale artificiale antrenat de voi (folosind cod propriu pentru dezvoltarea ANN-ului).
...
Punctajele acordate
- stabilirea sentimentului mesajului folosind client Azure - 50 puncte
